(function plannerFix() {
    ...
    function fixText(value) {
        ...
        return text
            .replace(/PLANT(?:AO|ÃƒO|[\u00c0-\u017f\ufffd]+O)/gi, APP_NAME)
            .replace(/Voc\ufffd/g, 'VocÃª')
            .replace(/n\ufffdo/g, 'nÃ£o')
            .replace(/N\ufffdo/g, 'NÃ£o')
    ...
    function replanejarAgoraCorrigido() {
        ...
        saveNow();
        refresh(today);
        if (typeof showToast === 'function') showToast('Plantao replanejado', 'Os atrasos foram redistribuÃ­dos respeitando as horas diÃ¡rias.');
    }
